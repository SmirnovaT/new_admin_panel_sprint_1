# Generated by Django 4.2.11 on 2024-04-01 13:41
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunSQL('CREATE SCHEMA IF NOT EXISTS content;'),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('movie', 'Movie'), ('tv_show', 'Show')], default='movie', max_length=20, verbose_name='type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('role', models.CharField(choices=[('director', 'Director'), ('actor', 'Actor'), ('writer', 'Writer')], max_length=20, verbose_name='role')),
